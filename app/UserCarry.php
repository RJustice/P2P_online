...
class UserCarry extends Model
{
    ...
    protected static function createdCallback($carry){
        ...
        $userLockMoneyLog->create_time_ymd = date('Y-m-d');
        $userLockMoneyLog->create_time_ym = date('Ym');
        $userLockMoneyLog->create_time_y = date('Y');
    ...
    protected static function _carryPassed($carry){
        ...
        $userDebitMoneyLog->create_time_y = date('Y');
    ...
    protected static function _carryNotPassed($carry){
        ...
        $userRefundMoneyLog->created_at = date('Y-m-d H:i:s');
        $userRefundMoneyLog->create_time_ymd = date('Y-m-d');
