...
class IHtmlServiceProvider extends ServiceProvider
{
    ...
    {
        Form::macro('ipanel_start', function ($title = '') {
    ...
    {
        Form::macro('imodal_button', function ($label, $modal, $data, $class = 'waves-effect') {
                    ...
                    foreach ($fields as $field) {
                        ...
                        if ($field == 'buttons') {
                            ...
                            if (array_key_exists($field, $functions)) {
                                // var_dump($field,strpos($field,'Model'));
                                if( strpos($field,'Model') !== false ){
                                    $value = $functions[$field]($item);
                                }else{
    ...
    {
        Html::macro('imodal_start', function ($id, $title) {
    ...
    {
        Html::macro('ijson', function ($data) {
    ...
    {
        Html::macro('imodal_end', function () {
    ...
    private function datagridHeader()
    {
        ...
        Html::macro('idatagrid_header', $handler);
    }

    private function datagridFooter()
    {
        Html::macro('ifooter', function ($data) {
