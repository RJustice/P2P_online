...
{!! Form::iform_select('categoryid','文章分类',\App\Category::getCategoriesOptions()) !!}
...
{!! Form::iform_text('from','来自什么媒体','媒体名称') !!}
{!! Form::iform_text('out_link','外链','填写外链,会自动连接到媒体报道的链接内容! 如无,请勿填写!') !!}
@section('js')
    @parent
    {!! UEditor::js() !!}
