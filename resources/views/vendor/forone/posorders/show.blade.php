...
<div class="row">
    <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    {!! Form::model($data,['method'=>'PUT','route'=>['admin.'.$uri.'.update',$data->order_sn],'class'=>'form-horizontal','id'=>'check-form']) !!}
                        ...
                        {!! Form::iform_text('posmoney','POS单金额','请输入POS单金额',1) !!}
        ...
        <p class="text-center">POS单号: <span class="price">{{ $data->posno }}</span></p>
        <p class="text-center"><img src="{{ asset($data->pospic) }}" alt=""></p>
        {!! Form::ipanel_end() !!}
    </div>
</div>
@stop
